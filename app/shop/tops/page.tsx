                    ...
                    <div className="max-w-md mx-auto">
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-12 pr-4 py-3 rounded-2xl border-2 border-pink-200 focus:border-pink-400 bg-white/90 backdrop-blur-sm shadow-lg text-gray-800 placeholder-gray-500"
                            />
                        </div>
                    </div>
                </div>
